...
import { ClientDataChange } from "../http/driversAPI";
import "../styles/driver.css";
import { getProfile } from '../http/userAPI';

const ClientsData = observer(() => {
    ...
    const ChangeData = async () => {
        ...
        try {
            ...
            const data = await ClientDataChange(lastName, firstName, patronymic, email, password, formattedBirthday, sanitizedPhone, user.userId);
        ...
        <Container className="registration-container">
            <Card className="registration-card">
                ...
                <Form className="registration-form">
                    ...
                    <Row className="registration-form-row">
                        <Col md={6} className="registration-form-col">
                            ...
                            <Form.Control
                                ...
                                maxLength={50}
                            />
                            {errors.patronymic && <Form.Control.Feedback type="invalid">{errors.patronymic}</Form.Control.Feedback>}
                        </Col>
                        <Col md={6} className="registration-form-col">
                    ...
                    <Row className="registration-form-row">
                        <Col md={6} className="registration-form-col">
                            <p className="registration-label">Введите телефон</p>
                            <Form.Control
                ...
                <Link to={USER_ROUTE}><Button className="exit" variant={'outline-danger'}>Выйти</Button></Link>
            </Card>
        </Container>
    );
});
